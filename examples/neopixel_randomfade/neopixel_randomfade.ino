...
const byte neopin = 3; // this is the pin Din or DATAIN is connected to for the WS2812 LEDs
const byte numleds = 20; // How many individual LEDs have you got?

Adafruit_NeoPixel pixels = Adafruit_NeoPixel(numleds, neopin, NEO_RGB + NEO_KHZ800);
...
int red1 = random(255);
int green1 = random(255);
int blue1 = random(255);
